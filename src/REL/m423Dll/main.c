...
void fn_1_F60(omObjData *arg0)
{
    ...
    temp_r30->bmpData = HuMemDirectMallocNum(HEAP_DATA, temp_r30->unk08, (uintptr_t)temp_r29->mallocNo);
    temp_r30->unk0C = 0.0f;
...
s32 fn_1_E678(void)
{
    ...
    var_r30->bmpData = HuMemDirectMallocNum(HEAP_DATA, var_r30->unk204, temp_r27->mallocNo);
