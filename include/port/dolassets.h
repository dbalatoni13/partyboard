...
#define coveropen_ge GetDolIncludeData(DOL_INCLUDE_COVEROPEN_GE)
#define fatalerror_ge GetDolIncludeData(DOL_INCLUDE_FATALERROR_GE)
#define loading_ge GetDolIncludeData(DOL_INCLUDE_LOADING_GE)
#define nodisc_ge GetDolIncludeData(DOL_INCLUDE_NODISC_GE)
#define retryerror_ge GetDolIncludeData(DOL_INCLUDE_RETRYERROR_GE)
#define wrongdisc_ge GetDolIncludeData(DOL_INCLUDE_WRONGDISC_GE)
